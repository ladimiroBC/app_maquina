...
const form_create_product_1 = require("./app/common/utils/class-utils/form-create-product");
const menu_view_application_1 = require("./app/common/utils/class-utils/menu-view-application");
const messages_application_1 = require("./app/common/utils/class-utils/messages-application");
